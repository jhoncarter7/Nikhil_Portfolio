...
const socialLinks = [
    {
        href: 'https://github.com/jhoncarter7',
    ...
    {
        href: 'https://www.linkedin.com/in/nikhil-rai-5409741b1/',
        icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
        href: 'https://x.com/Nikhilrai2744',
        icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
        href: 'https://www.instagram.com/nikhil__rai_3',
    ...
    return (
        <section id='contact' className="section">
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch ">
                ...
                <form
                    action="https://getform.io/f/bnlllpob"
                    method='POST'
                    ...
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        ...
                        <div className="">
                            ...
                            <input
                                ...
                                autoComplete='email'
                                required
                                placeholder='rainikhil044@gmail.com'
                                className="text-field reveal-up" />
                        </div>
                    </div>
